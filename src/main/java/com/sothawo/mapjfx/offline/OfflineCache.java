/*
 Copyright 2016-2020 Peter-Josef Meisch (pj.meisch@sothawo.com)
...
public enum OfflineCache {
     ...
     *
     * @param cacheFilters the patterns defining what to cache.
     */
     ...
     *
     * @param noCacheFilters the patterns defining what not to cache.
     */
     ...
     *
     * @param cacheDirectory the new directory
     * @throws NullPointerException     if cacheDirectory is null
     * @throws IllegalArgumentException if cacheDirectory does not exist or is not writeable
     */
     ...
     * @throws IllegalArgumentException if active is true and no cacheDirectory has been set.
     * @throws IllegalStateException    if the factory cannot be initialized.
     */
     ...
     *
     * @param url the url to store in the cache
     * @return the filename path for the url
     * @throws IllegalStateException        if no cacheDirectory is set.
     * @throws UnsupportedEncodingException if the url cannot be UTF-8
     * @throws NullPointerException         if url or it's external form is null
     */
     ...
     * .openstreetmap.org.
     *
     * @param urlString the string to map
     ...
     * @param cachedDataInfo the data info
     */
     ...
     * @param parallelism the number of threads to use for loading. If set to zero or below, the number of available processors is used.
     */
